...
class Block:
    ...
    Stores transactions in a blockchain that surpports a cryptocurrency
    """""
    ...
    def is_valid_block(last_block, block):
        """""
        Validate block by enforcing the rules below:
          - the block must have the proper last_hash reference
          - the block must meet the proof of work requirement
          - the dificulty must only adjust by one
          - the block hash must be a valid combination of the block felds
        """""
